		...
		extend: {
			colors: {
				...
				cardiology: {
					...
					light: 'hsl(var(--cardiology-light))'
				},
				radiology: {
					DEFAULT: 'hsl(var(--radiology))',
					light: 'hsl(var(--radiology-light))'
				},
				'emergency-service': {
					DEFAULT: 'hsl(var(--emergency-service))',
					light: 'hsl(var(--emergency-service-light))'
				},
				sidebar: {
